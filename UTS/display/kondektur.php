...
<body>
  ...
  <!-- Header -->
  <div class="container">
    <h2 class="header">Data Kondektur</h2>
  </div>
  <!-- Akhir header -->
  ...
  <div class="container">
    ...
    if (isset($_POST["submitUpdate"])) {
      if (updateKondektur($_POST) > 0) {
        echo '<div class="alert alert-success alert-dismissible fade show" role="alert" style="margin-top: 20px;">
                      <strong>Berhasil!</strong> Memperbarui data kondektur.
                      <form method="POST" action=""><button type="submit" name="submitClose" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></form>
                  </div>';
      } else {
        echo '<div class="alert alert-danger alert-dismissible fade show" role="alert" style="margin-top: 20px;">
                      <strong>Gagal!</strong> Memperbarui data kondektur.
                      <form method="POST" action=""><button type="button" name="submitClose" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></form>
                  </div>';
      }
    }
  ...
  <div class="container">
    ...
    if (isset($_POST["submitDelete"])) {
      if (deleteKondektur($_POST) > 0) {
        echo '<div class="alert alert-success alert-dismissible fade show" role="alert" style="margin-top: 20px;">
                      <strong>Berhasil!</strong> Menghapus data kondektur.
                      <form method="POST" action=""><button type="submit" name="submitClose" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></form>
                  </div>';
      } else {
        echo '<div class="alert alert-danger alert-dismissible fade show" role="alert" style="margin-top: 20px;">
                      <strong>Gagal!</strong> Menghapus data kondektur.
                      <form method="POST" action=""><button type="button" name="submitClose" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></form>
                  </div>';
      }
    }
        ...
        <?php foreach ($kondektur as $row) : ?>
          <tr class="text-center">
            ...
            <td class="d-flex justify-content-center">
              <a class="btn btn-warning btn-sm" style="margin-right: 5px;" data-bs-toggle="modal" data-bs-target="#modalUpdate<?php echo $row["id_kondektur"]; ?>">Update</a>
              <a class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modalDelete<?php echo $row["id_kondektur"]; ?>">Delete</a>
            </td>
          ...
          <!-- Modal update data -->
          <div class="modal fade" id="modalUpdate<?php echo $row["id_kondektur"]; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <?php
            $idKondektur = $row["id_kondektur"];
            $driverUpdate = query("SELECT * FROM kondektur WHERE id_kondektur = $idKondektur")[0];
            ?>
                ...
                <div class="modal-body">
                  ...
                  <form class="container" action="" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                      ...
                      <input value="<?php echo $driverUpdate["id_kondektur"]; ?>" type="text" class="form-control" name="id_kondektur" id="id_kondektur" placeholder="" readonly="readonly">
                    </div>
                    <div class="mb-3">
          ...
          <!-- Modal hapus data-->
          <div class="modal fade" id="modalDelete<?php echo $row["id_kondektur"]; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <?php
            $idKondektur = $row["id_kondektur"];
            $kondekturDelete = query("SELECT * FROM kondektur WHERE id_kondektur = $idKondektur")[0];
            ?>
                ...
                <form class="container" action="" method="post" enctype="multipart/form-data">
                  <div class="modal-body">
                    ...
                    <div class="mb-3" style="margin-top: 20px;">
                      <label for="id_kondektur" class="form-label">Id Driver</label>
                      <input value="<?php echo $kondekturDelete["id_kondektur"]; ?>" type="text" class="form-control" name="id_kondektur" id="id_kondektur" placeholder="" readonly="readonly">
                    </div>
                    <div class="mb-3">
                      <label for="nama" class="form-label">Nama</label>
                      <input value="<?php echo $kondekturDelete["nama"]; ?>" type="text" class="form-control" name="nama" id="nama" placeholder="">
                    </div>
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
