...
$driver = query("SELECT b.id_driver, b.nama, b.no_sim, b.alamat,SUM(t.jumlah_km) AS jumlah_km, t.tanggal, SUM(t.jumlah_km * 3000) AS gaji
                FROM driver b
...
if (isset($_POST["submitFilter"])) {
    $driver = query(filterGajiDriver($_POST));
}
?>
...
<body>
    ...
    <!-- Header -->
    <div class="container">
        <h2 class="header">Data Gaji Driver</h2>
